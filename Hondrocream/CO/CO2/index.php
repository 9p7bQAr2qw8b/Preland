...
@font-face {
	...
	font-style: normal;
	font-weight: 400;
	src: local("PT Sans"), local("PTSans-Regular"), url('http://med-vesti.com/sustvec2/jx7mlxqjsjnjqvi4hemmgvy6323mhuzfjmgtvxag2ie.woff2') format("woff2");
...
@font-face {
	...
	font-style: normal;
	font-weight: 400;
	src: local("PT Sans"), local("PTSans-Regular"), url('http://med-vesti.com/sustvec2/vtwnvmp8y9c17vlvibnzi_y6323mhuzfjmgtvxag2ie.woff2') format("woff2");
...
@font-face {
	...
	font-style: normal;
	font-weight: 400;
	src: local("PT Sans"), local("PTSans-Regular"), url('http://med-vesti.com/sustvec2/9kad4v2pnpmmeuvbhayd7vy6323mhuzfjmgtvxag2ie.woff2') format("woff2");
...
@font-face {
	...
	font-style: normal;
	font-weight: 400;
	src: local("PT Sans"), local("PTSans-Regular"), url('http://med-vesti.com/sustvec2/atkpv8nlyakuyexo8iqqrg.woff2') format("woff2");
...
@font-face {
	...
	font-style: normal;
	font-weight: 400;
	src: local("Open Sans"), local("OpenSans"), url('http://med-vesti.com/sustvec2/k88pr3goawt7btt32z01mxjtnkitppoi_ivcxxdnrsc.woff2') format("woff2");
	unicode-range: U+460-52F, U+20B4, U+2DE0-2DFF, U+A640-A69F;
}
@font-face {
	font-family: "Open Sans";
	font-style: normal;
	font-weight: 400;
	src: local("Open Sans"), local("OpenSans"), url('http://med-vesti.com/sustvec2/rjgo7rytmqivp7vzi-q5urjtnkitppoi_ivcxxdnrsc.woff2') format("woff2");
	unicode-range: U+400-45F, U+490-491, U+4B0-4B1, U+2116;
}
@font-face {
	font-family: "Open Sans";
	font-style: normal;
	font-weight: 400;
	src: local("Open Sans"), local("OpenSans"), url('http://med-vesti.com/sustvec2/lwcjsqkb6emdfhrevqa1krjtnkitppoi_ivcxxdnrsc.woff2') format("woff2");
...
@font-face {
	...
	font-style: normal;
	font-weight: 400;
	src: local("Open Sans"), local("OpenSans"), url('http://med-vesti.com/sustvec2/xozscpt2726on7jbcb_pahjtnkitppoi_ivcxxdnrsc.woff2') format("woff2");
...
@font-face {
	...
	font-style: normal;
	font-weight: 400;
	src: local("Open Sans"), local("OpenSans"), url('http://med-vesti.com/sustvec2/59zrklao5bwgqf5a9baeerjtnkitppoi_ivcxxdnrsc.woff2') format("woff2");
...
@font-face {
	...
	font-style: normal;
	font-weight: 400;
	src: local("Open Sans"), local("OpenSans"), url('http://med-vesti.com/sustvec2/u-wuoqret9fueobqw7jkrrjtnkitppoi_ivcxxdnrsc.woff2') format("woff2");
	unicode-range: U+100-24F, U+1E00-1EFF, U+20A0-20AB, U+20AD-20CF, U+2C60-2C7F, U+A720-A7FF;
}
...
@font-face {
	...
	font-style: normal;
	font-weight: 700;
	src: local("Open Sans Bold"), local("OpenSans-Bold"), url('http://med-vesti.com/sustvec2/k3k702zokiljc3wvjuplzk-j2u0lmlup9rwlsytm3ho.woff2') format("woff2");
	unicode-range: U+460-52F, U+20B4, U+2DE0-2DFF, U+A640-A69F;
}
@font-face {
	font-family: "Open Sans";
	font-style: normal;
	font-weight: 700;
	src: local("Open Sans Bold"), local("OpenSans-Bold"), url('http://med-vesti.com/sustvec2/k3k702zokiljc3wvjuplzbwv49_lsm1nyrwo-zkhivy.woff2') format("woff2");
	unicode-range: U+1F00-1FFF;
}
@font-face {
	font-family: "Open Sans";
	font-style: normal;
	font-weight: 700;
	src: local("Open Sans Bold"), local("OpenSans-Bold"), url('http://med-vesti.com/sustvec2/k3k702zokiljc3wvjuplzkarobkawv3vxw3jmhvenga.woff2') format("woff2");
	unicode-range: U+370-3FF;
}
@font-face {
	font-family: "Open Sans";
	font-style: normal;
	font-weight: 700;
	src: local("Open Sans Bold"), local("OpenSans-Bold"), url('http://med-vesti.com/sustvec2/k3k702zokiljc3wvjuplzp8zf_fossgrmwss7aa9k2w.woff2') format("woff2");
	unicode-range: U+102-103, U+1EA0-1EF9, U+20AB;
}
@font-face {
	font-family: "Open Sans";
	font-style: normal;
	font-weight: 700;
	src: local("Open Sans Bold"), local("OpenSans-Bold"), url('http://med-vesti.com/sustvec2/k3k702zokiljc3wvjuplzd0lw-43amezio6xutljad8.woff2') format("woff2");
	unicode-range: U+100-24F, U+1E00-1EFF, U+20A0-20AB, U+20AD-20CF, U+2C60-2C7F, U+A720-A7FF;
}
@font-face {
	font-family: "Open Sans";
	font-style: italic;
	font-weight: 400;
	src: local("Open Sans Italic"), local("OpenSans-Italic"), url('http://med-vesti.com/sustvec2/xjajxh38i15wypjxxugmbjtoq_mqjvwkksun0wkzc2i.woff2') format("woff2");
	unicode-range: U+460-52F, U+20B4, U+2DE0-2DFF, U+A640-A69F;
}
@font-face {
	font-family: "Open Sans";
	font-style: italic;
	font-weight: 400;
	src: local("Open Sans Italic"), local("OpenSans-Italic"), url('http://med-vesti.com/sustvec2/xjajxh38i15wypjxxugmbjuj_cnvwiuubmvgbx098mw.woff2') format("woff2");
	unicode-range: U+400-45F, U+490-491, U+4B0-4B1, U+2116;
}
@font-face {
	font-family: "Open Sans";
	font-style: italic;
	font-weight: 400;
	src: local("Open Sans Italic"), local("OpenSans-Italic"), url('http://med-vesti.com/sustvec2/xjajxh38i15wypjxxugmbkbckliaa1lc45dfaafaura.woff2') format("woff2");
	unicode-range: U+1F00-1FFF;
}
@font-face {
	font-family: "Open Sans";
	font-style: italic;
	font-weight: 400;
	src: local("Open Sans Italic"), local("OpenSans-Italic"), url('http://med-vesti.com/sustvec2/xjajxh38i15wypjxxugmbmo_suj8uo4ylwrins22t3y.woff2') format("woff2");
	unicode-range: U+370-3FF;
}
@font-face {
	font-family: "Open Sans";
	font-style: italic;
	font-weight: 400;
	src: local("Open Sans Italic"), local("OpenSans-Italic"), url('http://med-vesti.com/sustvec2/xjajxh38i15wypjxxugmbr6up8jxqwt8hva3mdhkv_0.woff2') format("woff2");
	unicode-range: U+102-103, U+1EA0-1EF9, U+20AB;
}
@font-face {
	font-family: "Open Sans";
	font-style: italic;
	font-weight: 400;
	src: local("Open Sans Italic"), local("OpenSans-Italic"), url('http://med-vesti.com/sustvec2/xjajxh38i15wypjxxugmbiye0-aqj3nfinttidxdju4.woff2') format("woff2");
	unicode-range: U+100-24F, U+1E00-1EFF, U+20A0-20AB, U+20AD-20CF, U+2C60-2C7F, U+A720-A7FF;
}
@font-face {
	font-family: "Open Sans";
	font-style: italic;
	font-weight: 400;
	src: local("Open Sans Italic"), local("OpenSans-Italic"), url('http://med-vesti.com/sustvec2/xjajxh38i15wypjxxugmbo4p5icox8kq3llunmylgo4.woff2') format("woff2");
	unicode-range: U+0-FF, U+131, U+152-153, U+2C6, U+2DA, U+2DC, U+2000-206F, U+2074, U+20AC, U+2212, U+2215;
}
/* ::::: http://health-online24.com/sustavy/1rub/dikul-1rub/reset.css ::::: */

/* ::::: http://health-online24.com/sustavy/1rub/dikul-1rub/index.css ::::: */
...
.vk-comment, .vk-comment-load { margin-bottom: 15px; position: relative; 
...
.vk-comment-name { color: #000; font-weight: bold; font-size: 12px; }
.vk-comment-text { margin-left: 60px; 


background: #eff1f3;border-radius: 20px; padding: 10px;
    ...
    <div class="header-top">
      ...
      <div class="content">
        <div class="content-left">
          <h1></h1>
          <center>
            <h1 class="lt0">Doctor Herrero: "¿Por qué llevas curando las articulaciones varios años, cuando se puede recuperarlas en 3 semanas?"</h1>
          </center>
...
<!--          <p><b>Корреспондент: "Здравствуйте, Евгений Львович. Как на сегодняшний день обстоят дела с разработкой препарата?"</b></p>-->
          ...
          <ul>
            ...
            <li class="lt10">Diclofenac;</li>
            <li class="lt11">Dexametasona;</li>
            <li class="lt12">Alflutop;</li>
            <li class="lt13">Movalis;</li>
            <li class="lt14">Mydocalm;</li>
            <li class="lt15">Meloxicam;</li>
            <li class="lt16">Prednisolona;</li>
            <li class="lt17">Teraflex;</li>
            <li class="lt18">Mukosat;</li>
            <li class="lt19">Airtal;</li>
            <li class="lt20">Condral;</li>
            <li class="lt21">Artra;</li>
            <li class="lt22">Artrosan;</li>
            <li class="lt23">Fermatron;</li>
            <li class="lt24">Celebrex;</li>
            <li class="lt25">Diaflex;</li>
            <li class="lt26">Chondrolon;</li>
            <li class="lt27">Sirdalud;</li>
            <li class="lt28">Ketorolaco;</li>
            <li class="lt29">Chondroxide;</li>
            <li class="lt30">Flamax;</li>
            <li class="lt31">Alopurinol;</li>
            <li class="lt32">Alflutop;</li>
            <li class="lt33">Flexen;</li>
            <li class="lt34">Fermatron Plus;</li>
            <li class="lt35">Artrosilene.</li>
          </ul>
            <p class="lt36">Algunos de ellos son realmente capaces de aliviar el dolor, pero en su mayoría dan un efecto temporal. Resulta que no tratan, sino que solo cortan el dolor sin influir en los procesos degenerativos. Además, el uso prolongado de tales medicamentos "daña" los riñones, el hígado y el estómago. Resulta un círculo cerrado: el paciente se ve obligado a usar constantemente un medicamento que afecta negativamente al cuerpo para reducir el dolor, mientras que la causa de este dolor no se cura. Además, las enfermedades de las articulaciones son en su esencia enfermedades extremadamente graves que conducen a consecuencias hasta los tumores cancerosos.</p>
          <p class="lt37">Veamos qué complicaciones pueden causar enfermedades de las articulaciones. Si tomamos las enfermedades más comunes de las articulaciones, entonces son:</p>
          <table border="1" cellpadding="5" width="100%">
            <tbody>
              <tr>
                <th class="lt38">Enfermedad</th>
                <th class="lt39">Complicaciones tempranas</th>
                <th class="lt40">Complicaciones en una etapa avanzada</th>
              </tr>
              <tr>
                <td class="lt41">Artritis</td>
                <td class="lt42">Necrosis del cartílago, destrucción de la articulación, sinovitis</td>
                <td class="lt43">Destrucción total de la articulación, septicemia, cáncer de articulación</td>
              </tr>
              <tr>
                <td class="lt44">Artrosis</td>
                <td class="lt45">Inflamación del cartílago, alteraciones en la estructura y degradación de la articulación, riesgo de septicemia</td>
                <td class="lt46">Discapacidad (la articulación deja de funcionar), destrucción del tejido cartilaginoso, cáncer de articulación</td>
              </tr>
              <tr>
                <td class="lt47">Osteocondrosis</td>
                <td class="lt48">Protrusión intervertebral, desplazamiento de discos intervertebrales, pellizco de nervios</td>
                <td class="lt49">Hernia de la columna vertebral, trastornos del sistema nervioso central, riesgo de que algunos órganos dejan de funcionar, tumores cancerosos de la columna vertebral</td>
              </tr>
              <tr>
                <td class="lt50">Coxartrosis</td>
                <td class="lt51">Protuberancias óseas, alteraciones degenerativas en el cartílago y la articulación, alteraciones distróficas en las cápsulas articulares</td>
                <td class="lt52">Restricciones de la actividad motora (discapacidad del 1 o 2 grupo), tumores cancerosos</td>
              </tr>
              <tr>
                <td class="lt53">Osteoporosis</td>
                <td class="lt54">Necrosis del tejido conjuntivo, necrosis ósea (aumenta la fragilidad ósea)</td>
                <td class="lt55">Deformación de los huesos y el esqueleto en general, falla de las extremidades, riesgo de cáncer debido a la necrosis ósea</td>
              </tr>
              <tr>
                <td class="lt56">Bursitis</td>
                <td class="lt57">Inflamación de la bolsa sinovial, acumulación de exudado purulento</td>
                <td class="lt58">Septicemia, falla de la articulación, putrefacción de los tejidos musculares, tumores malignos</td>
              </tr>
              <tr>
                <td class="lt59">Gota</td>
                <td class="lt60">Inflamación de la articulación del pie, deposición de sales, concentración de los cristales urinarios en los tejidos óseos</td>
                <td class="lt61">Formación del juanete en el pie y su crecimiento, alteraciones del tamaño de la articulación, necrosis de los tejidos óseos del pie, aparición de tumores benignos</td>
              </tr>
            </tbody>
          </table>
          ...
          <p><b></b></p>
          <center>
            <b class="lt72">Tratamiento de la cadera en un hombre. 44 años. Los dolores insoportables que acompañaron al paciente durante 2 años pasaron por completo:</b>
          </center>
          <p></p>
          <figure class="figure">
          ...
          <p><b></b></p>
          <center>
            <b class="lt73">Recuperación de la articulación del codo. Mujer, 31 años. El período de uso de la crema es de 2 meses. La articulación se recuperó completamente:</b>
          </center>
          <p></p>
          <p></p>
          <figure class="figure">
 ...
 <div class="un-wrapper">
            <form action="order.php" id="order_form" class="order_form cpa__order_form" method="POST">
                ...
                <div class="line">
                    <label for="phone">SU número
de mob.teléfono</label>
                    <div class="field">
                        <input type="text" id="phone" name="phone" value="" required>
                    </div>
                </div>
					<center><b><span style="font-size: 25px;" class="price_main">108.700$</span></b><br>
					<span style="text-decoration: line-through" class="price_old">217.400$</span></center><br>
                <center> <button class="submit green" type="submit">Ordenar</button></center>
            </form>
        </div>
    </div>
          ...
          <center>
            <h2 class="lt89">Recordamos que el programa estatal es vigente hasta <span class="nowdate"></span> inclusive.</h2>
          </center>
...
<!--
              <div class="vk-header-text">
                <span class="comment-count lt91">194 commenti oggi</span>
              </div>
-->
