...
function goToUrlFinish() {
    stepfinal();
    var e = jQuery("[name='url_f']").val(),
        n = getUrlParameter("transaction_id");
    window.location.href = "" != e && null != e ? e   : null;
}
url_f = atob(url_f), null != tid && (tid = getUrlParameter("clickid")), null != url_f && (null != tid && (url_f = url_f.includes("partner_param=") ? url_f.replace("[TRANSACTION]", tid) : url_f.includes("?") ? url_f + "&partner_param=" + tid : url_f + "?partner_param=" + tid), null != tsource && (url_f = url_f.includes("partner_param2=") ? url_f.replace("[SOURCE]", tsource) : url_f.includes("?") ? url_f + "&partner_param2=" + tsource : url_f + "?partner_param2=" + tsource), null != tpp3 && (url_f = url_f.includes("partner_param3=") ? url_f.replace("[SOURCE]", tpp3) : url_f.includes("?") ? url_f + "&partner_param3=" + tpp3 : url_f + "?partner_param3=" + tpp3), null != tcode && (url_f = url_f.includes("code=") ? url_f.replace("[SOURCE]", tcode) : url_f.includes("?") ? url_f + "&code=" + tcode : url_f + "?code=" + tcode), url_f = url_f.includes("?") ? url_f + "&prl=" + template + "_" + theme : url_f + "?prl=" + template + "_" + theme);