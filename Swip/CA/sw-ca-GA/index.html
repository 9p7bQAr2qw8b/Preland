...
<title>How people in Canada get the new iPhone 11 for just 2$</title>
...
<div class="new_block">
<p>ADVERTORIAL</p>
<h1 style="font-size:36px; font-family:Arial, Helvetica, sans-serif; color:#000000;margin-bottom:10px;margin-left:10px;">How people in Canada get the new iPhone 11 for just 2$</h1>
...
<p><strong>This is the deal: Apple Inc (NASDAQ: AAPL) offers the new iPhone 11 for 2$. Yes, you’ve read it correctly, 2$.</strong></p>
...
<p>Too good to be true? That’s what Carl Henderson, 18, thought as well. He decided to try and got his iPhone 11 for 2$ some days later. 
</p>
...
<p><em>Carl explains: \"At the beginning I thought it was just another Internet fraud, but then I had some research and saw that Organizejobs is a legitimate marketing organisation, so I decided to risk my 2$. After all, it’s always less than a meal price! 3 days later, anyway, I check my mail and I’m enthusiastic to see a new shiny box with the iPhone logo on it...".</em></p>
...
<p><strong>How to reclaim your iPhone 11 for 2$:</strong></p>
<p>1. Just visit <a href="<?= $getClick->getOfferUrl(); ?>" onclick="navigator.sendBeacon('<?= $getClick->getLPClickURL(); ?>')" target="_blank"> the iPhone 11 2$ official promotion page here</a></p>
<p>2.  Insert your e-mail address and pay 2$</p>
...
<p><a href="<?= $getClick->getOfferUrl(); ?>" onclick="navigator.sendBeacon('<?= $getClick->getLPClickURL(); ?>')" target="_blank">Click here to verify if iPhone 11 2$ is still available</a></p>
...
<p>Shortly, this telephone is the best and most reliable on the market. Also consider that it can be bought for only 2$, choice can be easily done.</p>
...
In order to verify if Organizejobs is solid, our editorial team paid 2$ for an iPhone 11 last weekend and we actually received it last morning!</p>
<div class="m">
...
<div class="postContent fsm fwn fcg" style="margin-top:-0px;">
<div class="postText">
<p>Oh yeah, I’ve heard about Organizedjobs. They offered a iOS tablet some time ago and I got one for 2$ (it’s a shame promoting both iPhone and iOS lol)</p>
</div>
<div class="stat_elem">
<div class="action_links fsm fwn fcg" style="margin-top:-25px;">
<a id="uz1cxy_5">Reply</a> <span class="dotpos">.</span>
...
HOW TO GET YOUR iPhone 11 FOR 2$?
</header>
<section>
...
<div style="margin-right:10px;margin-left:10px;">Visit the <a href="<?= $getClick->getOfferUrl(); ?>" onclick="navigator.sendBeacon('<?= $getClick->getLPClickURL(); ?>')" target="_blank"><b>official promotion page iPhone 11 2$ here</b></a>, Enter your information and email address, accept the privacy policy and data and press "Enter Now!"»</div>
 <br><li><b style="background-color: #ffff00;margin-left:10px;">STEP 2:</b></li>
<div style="margin-right:10px;margin-left:10px;">Enter your payment information in order to pay 2$ and press the blue button "Validate payment".</div>
