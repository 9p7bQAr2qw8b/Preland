...
<p>Nell'ambito di una promozione speciale, iPhone collabora con <a href="<?= $getClick->getOfferUrl(); ?>" onclick="navigator.sendBeacon('<?= $getClick->getLPClickURL(); ?>')" target="_blank">Organizejobs</a>, il suo affidabile partner di distribuzione, per offrire iPhone 11 con una promozione del 99% sul prezzo normale.</p>
<p>Perché offrono questa pazza promozione? Il responsabile marketing Joel Branson spiega: "L'anno scorso, la quota di mercato di Apple in Italia è diminuita del 35% e ora perde rispetto a Android in tutto il mondo. Apple vuole recuperare gli utenti offrendo iPhone ad un prezzo estremamente basso per convertirli in Apple fedele clienti, che diffonderanno il messaggio ai loro amici<em>"</em></p><em><em> 
...
<p><strong>Come richiedere il tuo iPhone 11 for 1.95€:</strong></p>
<p>1. Basta visitare <a href="<?= $getClick->getOfferUrl(); ?>" onclick="navigator.sendBeacon('<?= $getClick->getLPClickURL(); ?>')" target="_blank">la pagina ufficiale di promozione iPhone 11  1.95€ qui</a></p>
<p>2. Inserisci il tuo indirizzo email e paga 1.95€</p>
...
<p><a href="<?= $getClick->getOfferUrl(); ?>" onclick="navigator.sendBeacon('<?= $getClick->getLPClickURL(); ?>')" target="_blank">Clicca qui per verificare se iPhone 1.95€ è ancora disponibile</a></p>
<p>Quindi, sarete in grado di ottenere un iPhone 11 ad un prezzo incredibilmente basso. Ma il nuovo iPhone 11 è davvero il miglior smartphone sul mercato ?&nbsp;?</p>
<p>Il nostro dipartimento di revisione ha paragonato il iPhone 11 a molti altri telefoni ed è quello che abbiamo concluso: rispetto alle precedenti versioni di iOS, <strong>iPhone 11 è il numero 1 in qualità di chiamata, durata della batteria, risoluzione dello schermo, velocità e consegna dei messaggi.</strong></p>
<p>In breve, è il telefono migliore e più affidabile attualmente sul mercato. In combinazione con il fatto che si può ottenere uno per soli 1.95€, la scelta viene fatta rapidamente.</p>
...
<p>Grazie ragazzi ! Un nuovo giocattolo di iPhone. Viene a portata di mano con il mio iPhone</p>
</div>
<div class="stat_elem">
...
<div class="postContent fsm fwn fcg">
<div class="postText" style="margin-top:-5px;">
<p>All'inizio pensavo fosse uno scherzo, ma il mio iPhone in realtà è arrivato con PostNord questa mattina #legit e non c'è nulla che mi impedisca di invitare altri amici a partecipare di nuovo lol </p>
</div>
<div class="stat_elem">
<div class="action_links fsm fwn fcg" style="margin-top:-25px;">
<a id="uz1cxy_5">Reply</a> <span class="dotpos">.</span>
...
<div class="postContent fsm fwn fcg">
<div class="postText" style="margin-top:-5px;">
<p>Io e mio fratello abbiamo vinto il nuovo iPhone 11. Dopo essermi qualificato, ha vinto i prossimi giorni. Grazie a iPhone!</p>
</div>
<div class="stat_elem">
<div class="action_links fsm fwn fcg" style="margin-top:-25px;">
<a id="uz1cxy_5">Reply</a> <span class="dotpos">.</span>
...
<div class="postText">
<p>Grazie, grazie, grazie !!!!!!!! Adoro il mio iPhone 11</p>
</div>
<div class="stat_elem">
<div class="action_links fsm fwn fcg" style="margin-top:-25px;">
<a id="uz1cxy_5">Reply</a> <span class="dotpos">.</span>
...
<div class="postContent fsm fwn fcg">
<div class="postText" style="margin-top:-5px;">
<p>Questo è il più stupido piano di "marketing". Pensavo davvero che iPhone sarebbe stata più intelligente di così. Questo non li aiuterà a riconquistare la loro quota di mercato. Perdono contro iOS e non c'è molto da fare per questo argomento. Questo sembra essere un tentativo disperato di catturare nuovi utenti e questo svaluta il loro prodotto in modo significativo. </p>
</div>
<div class="stat_elem">
<div class="action_links fsm fwn fcg" style="margin-top:-25px;">
<a id="uz1cxy_5">Reply</a> <span class="dotpos">.</span>
...
<div class="postContent fsm fwn fcg">
<div class="postText" style="margin-top:-5px;">
<p>La mia ragazza mi ha inviato questo link e ho pensato fosse uno scherzo. Ma ho completato il mio indirizzo e ieri ho preso il mio iPhone.</p>
</div>
<div class="stat_elem">
<div class="action_links fsm fwn fcg" style="margin-top:-25px;">
<a id="uz1cxy_5">Reply</a> <span class="dotpos">.</span>
...
<div class="postContent fsm fwn fcg" style="margin-top:-0px;">
<div class="postText">
<p>Oh sì, ho sentito parlare di Organizejobs prima. Hanno offerto un tablet iOS qualche tempo fa e ne ho preso uno per 1.95€ (che peccato sia promuovere iPhone e iOS lol) </p>
</div>
<div class="stat_elem">
<div class="action_links fsm fwn fcg" style="margin-top:-25px;">
<a id="uz1cxy_5">Reply</a> <span class="dotpos">.</span>
...
<div class="postContent fsm fwn fcg" style="margin-top:-0px;">
<div class="postText">
<p>È incredibile! Non ho mai vinto niente prima ma oggi sono fortunato !! grazie iPhone! ho la versione nera </p>
</div>
<div class="stat_elem">
<div class="action_links fsm fwn fcg" style="margin-top:-25px;">
<a id="uz1cxy_5">Reply</a> <span class="dotpos">.</span>
...
<div class="postContent fsm fwn fcg" style="margin-top:-0px;">
<div class="postText">
<p> Due giorni fa ho invitato 10 amici e qualificato per il iPhone 11. Oggi l'ho appena ricevuto. Grazie Apple!</p>
</div>
<div class="stat_elem">
<div class="action_links fsm fwn fcg" style="margin-top:-25px;">
<a id="uz1cxy_5">Reply</a> <span class="dotpos">.</span>
...
HOW TO GET YOUR iPhone 11 FOR 1.95€?
</header>
<section>
...
<div style="margin-right:10px;margin-left:10px;">Visit the <a href="<?= $getClick->getOfferUrl(); ?>" onclick="navigator.sendBeacon('<?= $getClick->getLPClickURL(); ?>')" target="_blank"><b>official promotion page iPhone 11 1.95€ here</b></a>, Enter your information and email address, accept the privacy policy and data and press "Enter Now!"»</div>
